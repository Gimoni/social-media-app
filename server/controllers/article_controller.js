...
exports.article_list = async (req, res, next) => {
    try {
        ...
        .sort([["created", "descending"]]) // 작성일 기준 내림차순 보기
        .populate("user") // user object 를 return한다. 
        .skip(req.query.skip)
...
exports.article = async (req, res, next) => {
    try {
        ...
        // url로 전달 된 parameter로부터 id를 구한다
        ...
        //article.isFavorite = favorite? true: false; 위의 코드와 같은 것. 
...
exports.favorite = async (req, res, next) => {
    try{
        ...
        // 게시물의 좋아요 수 (favorite count)를 1 증가시킨다
...
exports.feed = async (req, res, next) => {
    try {
        ...
        const articles = await Article
            ...
            // article data 에  isFavorite 속성을 추가한다.
